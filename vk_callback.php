...
$secret_key = 'ebK8jKsm6Yb1iGUOhgEB'; // Защищенный ключ приложения
	...
	switch ($input['notification_type']){
		case 'get_item':
			...
			if ($item == 'item_id_1'){
				$response['response'] = array(
					'item_id' => 101,
					'title' => 'Бесконечная энергия + отключение рекламы',
					'photo_url' => 'https://ibb.co/yy6VKGP',
					'price' => 1
				);
			}
		break;
		...
		case 'get_item_test':
			...
			if ($item == 'item_id_1'){
				$response['response'] = array(
					'item_id' => 201,
					'title' => 'Бесконечная энергия + отключение рекламы (тестовый режим)',
					'photo_url' => 'https://ibb.co/yy6VKGP',
					'price' => 1
				);
			}
